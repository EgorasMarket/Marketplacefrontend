            ...
            {user === null && loading === false ? (
              <>
                ...
                <a href="/register" className="Header_div_area_div2_btn1_link">
                  <button className="Header_div_area_div2_btn2">
                    Get started
                  </button>
                </a>
              </>
            ) : (
              <a href="/app/home" className="Header_div_area_div2_btn1_link">
                <button className="Header_div_area_div2_btn1_login">
                  Enter App <Login03Icon size={20} className="login_icon" />
                </button>
              </a>
            )}
